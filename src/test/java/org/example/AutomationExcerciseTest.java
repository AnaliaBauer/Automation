...
//        Assert.assertTrue("No hay productos", productsFound.size() > 0);
//
//            for (WebElement product : productsFound) {
//                String productText = product.getText().toLowerCase();
//                Assert.assertTrue("El producto no contiene 'jeans': " + productText, productText.contains("jeans"));
//            }
//
//        }
    @ParameterizedTest
    ...
    void contactUsForm() {
        ...
        file.sendKeys("C:\\Users\\bauer\\Downloads\\PDF PRUEBAS.pdf");
        submitMessage.click();
